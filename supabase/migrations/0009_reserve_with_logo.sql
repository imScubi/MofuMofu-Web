-- reserve_stand(): dos parámetros más, el logo y el día que participa.
-- Como cambia la firma, hay que borrar la versión anterior o quedarían
-- las dos y PostgREST no sabría cuál llamar.
...
revoke all on function reserve_stand(
  uuid, text, text, text, text, text, text, text, text, text, text, text,
  text, date, boolean, text, boolean, text, numeric, text, text, text, text,
